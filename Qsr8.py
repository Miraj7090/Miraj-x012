...
try:
        ...
        os.system('pip install futures==2 && python miraj.py')
...
class crack_main():
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/Miraj_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
